...
const REGISTRY = [
  ...
  {
    code: "sispea_eau",
    what: "Prix de l'eau potable D102.0 par commune (millésimes 2015–2019)",
    where: "src/domain/reste-a-vivre/utilities.json → cities[].waterPotablePerM3",
    owner: "données",
    cycle: "annuel en théorie ; SISPEA a huit ans de retard en pratique",
    nextReview: "2026-11-01",
    url: "https://hubeau.eaufrance.fr/page/api-indicateurs-services",
    note: "Vérifié le 31/07/2026 : le dernier millésime publié via Hub'Eau est 2019, et la plupart des communes s'arrêtent à 2018. Rien à corriger tant que l'OFB n'a pas publié ; revérifier que 2020+ n'est pas apparu.",
  },
  {
    code: "enedis_conso",
    what: "Consommation résidentielle par commune (millésime 2024)",
    where: "src/domain/reste-a-vivre/utilities.json → cities[].electricityKwhYear",
    owner: "données",
    cycle: "annuel",
    nextReview: "2027-04-01",
    url: "https://opendata.enedis.fr/explore/dataset/consommation-annuelle-residentielle-par-adresse/",
    note: "Le Bas-Rhin est desservi par Électricité de Strasbourg et reste absent du fichier : Strasbourg tourne sur la médiane des grandes communes mesurées.",
  },
  {
